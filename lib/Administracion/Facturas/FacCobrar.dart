...
class _RegistroCobrarFacturasState extends State<RegistroCobrarFacturas> {
  ...
  void _guardarFactura() {
    ...
    Provider.of<FacturaCobrarProvider>(context, listen: false).agregarFactura(factura);
  ...
  void _mostrarDialogoConfirmacion() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('¿Desea registrar otra factura?'),
        actions: [
          TextButton(
            child: const Text('No'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Registro de Pagos Facturas por Cobrar')),
        ...
        child: Form(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Expanded(child: _buildTextField('N° Factura', _nroFacturaController, icon: Icons.receipt_long)),
                  const SizedBox(width: 10),
              ...
              _buildTextField('Acuenta 1', _acuenta1Controller, isNumeric: true, icon: Icons.account_balance, onChanged: (_) => _calcularSaldo()),
              _buildTextField('Acuenta 2', _acuenta2Controller, isNumeric: true, icon: Icons.account_balance, onChanged: (_) => _calcularSaldo()),
              _buildTextField('Acuenta 3', _acuenta3Controller, isNumeric: true, icon: Icons.account_balance, onChanged: (_) => _calcularSaldo()),
